...
public class ManagerRegistry implements GridManager.AdProvidersCallback {
  ...
  public ManagerRegistry(Activity activity, ConfigurationParser configurationParser, AdProvidersRegistry adProvidersMap, EventTracker eventLogger, AdSummaryEventHandler adSummaryEventHandler) {
    ...
    AdSelector bannerAdSelector = new BannerWaterfallAdSelector(uiHandler, activity, bannerEventHandler);
    ...
    CommonAdManager bannerAds = new BannerAdManager(activity, configurationParser, bannerAdSelector, adProvidersMap, uiHandler, HandlerFactory.createHandler(BannerAdManager.class), bannerEventHandler, adSummaryEventHandler);
