...
public class Banner {
  ...
  private int layout = R.layout.info;
  ...
  public static Banner make(View view, Activity activity, String message, int position) {
   ...
   */
  public static Banner make(View view, Activity activity, String message, int position, int duration) {
    if (instance == null) {
      instance = new Banner();
    } else {
      if (instance.showBanner) {
  ...
  public void setLayout(int layout) {
    if (activity != null) {
      LayoutInflater inflater = (LayoutInflater)
        activity.getBaseContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
